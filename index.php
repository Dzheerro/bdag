...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 4100;
        $headers['auth']['clientCompany'] = "BMkLASnOkIlD0PrWepOy";
        $headers['auth']['clientSecret'] = "NDEwMEJNa0xBU25Pa0lsRDBQcldlcE95Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
        $headers['server']['bannerSource'] = 'tiktok';
