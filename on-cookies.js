...
const languageDictionary = {
  ar: {
    "cookie-accept__heading":
      "مرحبًا! بالمناسبة، نحن نستخدم ملفات تعريف الارتباط.",
    "cookie-accept__text-1":
      "يتم استخدام ملفات تعريف الارتباط للوصول إلى المعلومات وتخزينها على جهازك حتى نتمكن من تقديم محتوى مخصص بناءً على بياناتك.",
    "cookie-accept__text-2":
      'باختيار "أوافق"، فإنك توافق على استخدامنا لملفات تعريف الارتباط. ويمكنك الرفض\n' +
    ...
    "cookie-settings__intro":
      "هنا يمكنك إدارة تفضيلات ملفات تعريف الارتباط الخاصة بك",
    "cookie-settings__subheading1": "ملفات تعريف الارتباط الأساسية",
    "cookie-settings__description1":
      "ملفات تعريف الارتباط الأساسية أو ملفات تعريف الارتباط الضرورية للغاية هي ملفات تعريف الارتباط الضرورية لكي يعمل موقع الويب بشكل صحيح. وهي ملفات تعريف الارتباط الضرورية لتقديم خدمة عبر الإنترنت على موقع ويب أو تُستخدم فقط لتنفيذ أو تسهيل نقل الاتصالات عبر الشبكة.",
    "cookie-settings__subheading2": "ملفات تعريف الارتباط الخاصة بالأداء",
    "cookie-settings__description2":
      "تقوم ملفات تعريف الارتباط الخاصة بالأداء بجمع البيانات حول تفاعلات المستخدم داخل موقع الويب. يشار إليها باسم ملفات تعريف الارتباط التحليلية، وهي تعمل على تتبع مشاهدات الصفحة، وقياس مدة مشاركة المستخدم، وتحديد الأخطاء في الصفحات التي بها خلل، ومراقبة معدلات الارتداد و أوقات تحميل الموقع.",
    "cookie-settings__subheading3": "ملفات تعريف الارتباط الإعلانية",
    "cookie-settings__description3":
      "تقوم ملفات تعريف الارتباط الإعلانية بجمع المعلومات من جهازك لعرض الإعلانات التي تتوافق مع اهتماماتك. يتم تعيين ملفات تعريف الارتباط هذه بواسطة المعلنين بإذن مالك موقع الويب للتأكد من أن الإعلانات التي تراها ذات صلة بك.",
    "cookie-settings__preference-button": "حفظ التفضيلات",
    "cookie-settings__policy-link": "سياسة ملفات تعريف الارتباط",
  },
  az: {
    "cookie-accept__heading":
      "Hey! Yeri gəlmişkən, kukilərdən istifadə edirik.",
    "cookie-accept__text-1":
      "Kukilər cihazınızda məlumat əldə etmək və saxlamaq üçün istifadə olunur ki, biz sizin məlumatlarınız əsasında fərdiləşdirilmiş məzmun təklif edirik.",
    "cookie-accept__text-2":
      '"Razıyam" seçməklə kukilərdən istifadəmizə razılıq verirsiniz. Siz imtina edə bilərsiniz\n' +
    ...
    "cookie-settings__description1":
      "Əsas kukilər və ya ciddi şəkildə zəruri kukilər vebsaytın düzgün işləməsi üçün vacib olan kukilərdir. Bunlar vebsaytda onlayn xidmət göstərmək üçün zəruri olan və ya yalnız məlumatların ötürülməsini həyata keçirmək və ya asanlaşdırmaq üçün istifadə olunan kukilərdir. şəbəkə üzərindən rabitə.",
    "cookie-settings__subheading2": "Performans kukiləri",
    "cookie-settings__description2":
      "Performans kukiləri veb-sayt daxilində istifadəçi qarşılıqlı əlaqələri haqqında məlumat toplayır. Analitik kukilər kimi istinad edilir, onlar səhifə baxışlarını izləmək, istifadəçinin əlaqə müddətini ölçmək, nasaz səhifələrdəki xətaları müəyyən etmək və həm sıçrayış, həm də geri dönmə nisbətlərinə nəzarət etmək üçün xidmət edir. saytın yükləmə vaxtları.",
    "cookie-settings__subheading3": "Reklam kukiləri",
    "cookie-settings__description3":
      "Reklam kukiləri maraqlarınıza uyğun gələn reklamları göstərmək üçün cihazınızdan məlumat toplayır. Bu kukilər gördüyünüz reklamların sizə uyğun olmasını təmin etmək üçün vebsayt sahibinin icazəsi ilə reklamçılar tərəfindən təyin edilir.",
  ...
  bg: {
    ...
    "cookie-accept__text-1":
      "Бисквитките се използват за достъп и съхраняване на информация на вашето устройство, така че да предлагаме персонализирано съдържание въз основа на вашите данни.",
    "cookie-accept__text-2":
      'Избирайки "Съгласен съм", вие се съгласявате с използването на бисквитки. Можете да откажете\n' +
    ...
    "cookie-settings__intro":
      "Тук можете да управлявате вашите предпочитания за бисквитки:",
    "cookie-settings__subheading1": "Основни бисквитки",
    "cookie-settings__description1":
      "Основните бисквитки или строго необходимите бисквитки са бисквитки, които са от съществено значение за правилното функциониране на даден уебсайт. Това са бисквитки, които са необходими за предоставяне на онлайн услуга на уебсайт или се използват единствено за извършване или улесняване на предаването на комуникации по мрежа.",
    "cookie-settings__subheading2": "Бисквитки за ефективност",
    "cookie-settings__description2":
      "Бисквитките за ефективност събират данни за потребителските взаимодействия в рамките на уебсайт. Наричани аналитични бисквитки, те служат за проследяване на показвания на страници, измерване на продължителността на ангажираност на потребителите, идентифициране на грешки на неправилно функциониращи страници и наблюдение както на степента на отпадане, така и времена за зареждане на сайта.",
    "cookie-settings__subheading3": "Рекламни бисквитки",
    "cookie-settings__description3":
      "Рекламните бисквитки събират информация от вашето устройство, за да показват реклами, които отговарят на вашите интереси. Тези бисквитки се задават от рекламодатели с разрешението на собственика на уебсайта, за да гарантират, че рекламите, които виждате, са подходящи за вас.",
  ...
  bn: {
    ...
    "cookie-accept__text-1":
      "Файлы cookie выкарыстоўваюцца для доступу і захоўвання інфармацыі на вашай прыладзе, каб мы прапаноўвалі персаналізаваны кантэнт на аснове вашых даных.",
    "cookie-accept__text-2":
      'Выбіраючы "Я згаджаюся", вы згаджаецеся на выкарыстанне намі файлаў cookie. Вы можаце адмовіцца\n' +
    ...
    "cookie-settings__intro":
      "Тут вы можаце кіраваць сваімі наладамі файлаў cookie:",
    "cookie-settings__subheading1": "Асноўныя файлы cookie",
    "cookie-settings__description1":
      "Асноўныя кукі або строга неабходныя кукі - гэта кукі, неабходныя для карэктнай працы вэб-сайта. Гэта кукі, неабходныя для прадастаўлення інтэрнэт-сэрвісаў на вэб-сайце або выкарыстоўваюцца выключна для выканання або палягчэння перадачы сувязь праз сетку.",
    "cookie-settings__subheading2": "Прадукцыйныя файлы cookie",
    "cookie-settings__description2":
      "Прадукцыйныя файлы cookie збіраюць даныя аб узаемадзеянні карыстальнікаў на вэб-сайце. Называюцца аналітычнымі файламі cookie, яны служаць для адсочвання праглядаў старонак, вымярэння працягласці ўзаемадзеяння карыстальнікаў, выяўлення памылак на старонках, якія не працуюць, а таксама маніторынгу паказчыкаў адмоваў і час загрузкі сайта.",
    "cookie-settings__subheading3": "Рэкламныя файлы cookie",
    "cookie-settings__description3":
      "Рэкламныя файлы cookie збіраюць інфармацыю з вашай прылады, каб паказваць рэкламу, якая адпавядае вашым інтарэсам. Гэтыя файлы cookie ўсталёўваюцца рэкламадаўцамі з дазволу ўладальніка сайта, каб гарантаваць, што рэклама, якую вы бачыце, адпавядае вам.",
  ...
  zh: {
    ...
    "cookie-accept__text-1":
      "Cookie 用于访问和存储您设备上的信息，以便我们根据您的数据提供个性化内容。",
    "cookie-accept__text-2":
      '选择"我同意"即表示您同意我们使用cookie。您可以拒绝\n' +
      " 或通过选择“管理设置”撤回同意。",
    ...
    "cookie-settings__description1":
      "基本 cookie 或严格必要的 cookie 是网站正常运行所必需的 cookie。这些 cookie 是在网站上提供在线服务所必需的，或者仅用于执行或促进传输 通过网络进行通信。",
    "cookie-settings__subheading2": "性能 Cookie",
    "cookie-settings__description2":
      "性能 cookie 收集网站内用户交互的数据。称为分析 cookie，它们用于跟踪页面浏览量、测量用户参与的持续时间、识别故障页面上的错误以及监控跳出率和 网站加载时间。",
    "cookie-settings__subheading3": "广告 Cookie",
    "cookie-settings__description3":
      "广告 cookie 从您的设备收集信息，以展示符合您兴趣的广告。这些 cookie 由广告商在网站所有者的许可下设置，以确保您看到的广告与您相关。",
  ...
  cs: {
    ...
    "cookie-accept__text-1":
      "Soubory cookie se používají k přístupu a ukládání informací ve vašem zařízení, abychom mohli nabízet personalizovaný obsah založený na vašich datech.",
    "cookie-accept__text-2":
      'Výběrem možnosti "Souhlasím" souhlasíte s naším používáním souborů cookie. Můžete odmítnout\n' +
    ...
    "cookie-settings__description1":
      "Základní soubory cookie nebo nezbytně nutné soubory cookie jsou soubory cookie, které jsou nezbytné pro správné fungování webových stránek. Jedná se o soubory cookie, které jsou nezbytné k poskytování online služby na webu nebo se používají výhradně k provádění nebo usnadnění přenosu komunikace po síti.",
    "cookie-settings__subheading2": "Soubory cookie pro výkon",
    "cookie-settings__description2":
      "Soubory cookie výkonu shromažďují údaje o uživatelských interakcích na webu. Označují se jako analytické soubory cookie a slouží ke sledování zobrazení stránek, měření trvání zapojení uživatelů, identifikaci chyb na nefunkčních stránkách a sledování míry okamžitého opuštění a časy načítání stránek.",
    "cookie-settings__subheading3": "Reklamní soubory cookie",
    "cookie-settings__description3":
      "Reklamní soubory cookie shromažďují informace z vašeho zařízení za účelem zobrazování reklam, které odpovídají vašim zájmům. Tyto soubory cookie nastavují inzerenti se svolením vlastníka webu, aby zajistili, že zobrazené reklamy jsou pro vás relevantní.",
  ...
  de: {
    ...
    "cookie-accept__text-1":
      "Cookies werden verwendet, um auf Informationen auf Ihrem Gerät zuzugreifen und diese zu speichern, damit wir personalisierte Inhalte basierend auf Ihren Daten anbieten können.",
    "cookie-accept__text-2":
      "Durch die Auswahl von „Ich stimme zu“ stimmen Sie der Verwendung von Cookies zu. Sie können dies ablehnen\n" +
    ...
    "cookie-settings__description1":
      "Notwendige Cookies oder unbedingt notwendige Cookies sind Cookies, die für das ordnungsgemäße Funktionieren einer Website unbedingt erforderlich sind. Dabei handelt es sich um Cookies, die für die Bereitstellung eines Onlinedienstes auf einer Website erforderlich sind oder ausschließlich dazu dienen, die Übermittlung durchzuführen oder zu erleichtern.“ Kommunikation über ein Netzwerk.",
    "cookie-settings__subheading2": "Leistungscookies",
    "cookie-settings__description2":
      "Leistungscookies sammeln Daten über Benutzerinteraktionen innerhalb einer Website. Sie werden als Analysecookies bezeichnet und dienen dazu, Seitenaufrufe zu verfolgen, die Dauer der Benutzerinteraktion zu messen, Fehler auf nicht funktionierenden Seiten zu identifizieren und sowohl Absprungraten als auch zu überwachen Ladezeiten der Website.",
    "cookie-settings__subheading": "Werbe-Cookies",
    "cookie-settings__description3":
      "Werbe-Cookies sammeln Informationen von Ihrem Gerät, um Anzeigen zu schalten, die Ihren Interessen entsprechen. Diese Cookies werden von Werbetreibenden mit Erlaubnis des Website-Eigentümers gesetzt, um sicherzustellen, dass die Anzeigen, die Sie sehen, für Sie relevant sind.",
  ...
  en: {
    ...
    "cookie-accept__text-1":
      "Cookies are used to access and store information on your device so that we offer personalized content based on your data.",
    "cookie-accept__text-2":
      'By choosing "I agree", you consent to our use of cookies. You can refuse\n' +
    ...
    "cookie-settings__description1":
      "Essential cookies or strictly necessary cookies are cookies that are essential for a website to function correctly. These are cookies that are necessary to provide an online service on a website or used solely to carry out or facilitate the transmission of communications over a network.",
    "cookie-settings__subheading2": "Performance Cookies",
    "cookie-settings__description2":
      "Performance cookies gather data on user interactions within a website. Referred to as analytics cookies, they serve to track page views, measure the duration of user engagement, identify errors on malfunctioning pages, and monitor both bounce rates and site loading times.",
    "cookie-settings__subheading3": "Advertising Cookies",
    "cookie-settings__description3":
      "Advertising cookies collect information from your device to show ads that match your interests. These cookies are set by advertisers with the website owner’s permission to ensure the ads you see are relevant to you.",
  ...
  es: {
    ...
    "cookie-accept__text-1":
      "Las cookies se utilizan para acceder y almacenar información en su dispositivo para que podamos ofrecer contenido personalizado basado en sus datos.",
    "cookie-accept__text-2":
      'Al elegir "Acepto", aceptas nuestro uso de cookies. Puedes rechazar\n' +
    ...
    "cookie-settings__intro":
      "Aquí puedes administrar tus preferencias de cookies:",
    "cookie-settings__subheading1": "Cookies esenciales",
    "cookie-settings__description1":
      "Las cookies esenciales o cookies estrictamente necesarias son cookies que son esenciales para que un sitio web funcione correctamente. Son cookies que son necesarias para proporcionar un servicio en línea en un sitio web o se utilizan únicamente para realizar o facilitar la transmisión de comunicaciones a través de una red.",
    "cookie-settings__subheading2": "Cookies de rendimiento",
    "cookie-settings__description2":
      "Las cookies de rendimiento recopilan datos sobre las interacciones del usuario dentro de un sitio web. Conocidas como cookies de análisis, sirven para realizar un seguimiento de las visitas a la página, medir la duración de la participación del usuario, identificar errores en páginas que no funcionan correctamente y monitorear las tasas de rebote y tiempos de carga del sitio.",
    "cookie-settings__subheading3": "Cookies publicitarias",
    "cookie-settings__description3":
      "Las cookies publicitarias recopilan información de su dispositivo para mostrar anuncios que coincidan con sus intereses. Estas cookies las configuran los anunciantes con el permiso del propietario del sitio web para garantizar que los anuncios que ve sean relevantes para usted.",
  ...
  fr: {
    ...
    "cookie-accept__text-1":
      "Les cookies sont utilisés pour accéder et stocker des informations sur votre appareil afin que nous puissions proposer un contenu personnalisé basé sur vos données.",
    "cookie-accept__text-2":
      'En choisissant "J\'accepte", vous consentez à notre utilisation des cookies. Vous pouvez refuser\n' +
    ...
    "cookie-settings__intro":
      "Ici, vous pouvez gérer vos préférences en matière de cookies :",
    ...
    "cookie-settings__description2":
      "Les cookies de performance collectent des données sur les interactions des utilisateurs au sein d'un site Web. Appelés cookies d'analyse, ils servent à suivre les pages vues, à mesurer la durée de l'engagement des utilisateurs, à identifier les erreurs sur les pages défectueuses et à surveiller à la fois les taux de rebond et temps de chargement du site.",
    "cookie-settings__subheading3": "Cookies publicitaires",
    "cookie-settings__description3":
      "Les cookies publicitaires collectent des informations sur votre appareil pour afficher des publicités qui correspondent à vos intérêts. Ces cookies sont définis par les annonceurs avec l'autorisation du propriétaire du site Web pour garantir que les publicités que vous voyez vous concernent.",
  ...
  he: {
    ...
    "cookie-accept__text-1":
      "קובצי Cookie משמשים לגישה ואחסון מידע במכשיר שלך כך שאנו מציעים תוכן מותאם אישית על סמך הנתונים שלך.",
    "cookie-accept__text-2":
      'על ידי בחירת "אני מסכים", אתה מסכים לשימוש שלנו בקובצי Cookie. אתה יכול לסרב\n' +
    ...
    "cookie-settings__description1":
      "עוגיות חיוניות או קובצי Cookie הכרחיים בהחלט הם קובצי Cookie החיוניים לתפקוד תקין של אתר אינטרנט. אלו הן קובצי Cookie הנחוצים למתן שירות מקוון באתר או המשמשים אך ורק לביצוע או להקל על שידור של תקשורת דרך רשת.",
    "cookie-settings__subheading2": "עוגיות ביצועים",
    "cookie-settings__description2":
      "עוגיות ביצועים אוספות נתונים על אינטראקציות של משתמשים בתוך אתר אינטרנט. מכונות עוגיות אנליטיות, הן משמשות לעקוב אחר צפיות בדפים, למדוד את משך מעורבות המשתמש, לזהות שגיאות בדפים לא תקינים, ולנטר את שיעורי היציאה מדף הכניסה והן. זמני טעינת האתר.",
    "cookie-settings__subheading3": "עוגיות פרסום",
    "cookie-settings__description3":
      "עוגיות פרסום אוספות מידע מהמכשיר שלך כדי להציג מודעות התואמות את תחומי העניין שלך. קובצי Cookie אלה מוגדרים על ידי מפרסמים באישור בעל האתר כדי להבטיח שהמודעות שאתה רואה רלוונטיות עבורך.",
  ...
  hr: {
    ...
    "cookie-accept__text-1":
      "Kolačići se koriste za pristup i pohranu informacija na vašem uređaju, stoga vam nudimo personalizirani sadržaj na temelju vaših podataka.",
    "cookie-accept__text-2":
      'Odabirom opcije "Slažem se", pristajete na našu upotrebu kolačića. Možete odbiti ili povući svoj pristanak odabirom "Upravljanje postavkama".',
    ...
    "cookie-settings__description1":
      "Osnovni kolačići ili strogo nužni kolačići su kolačići koji su potrebni za pravilno funkcioniranje web stranice. To su kolačići potrebni za pružanje online usluga na web stranici ili se koriste isključivo za izvođenje ili olakšavanje prijenosa komunikacije preko mreže.",
    "cookie-settings__subheading2": "Kolačići za izvedbu",
    "cookie-settings__description2":
      "Kolačići za izvedbu prikupljaju podatke o interakciji korisnika na web stranici. Nazivaju se analitički kolačići. Služe za praćenje pregleda stranica, mjerenje trajanja interakcije korisnika, identifikaciju pogrešaka na stranicama koje ne rade, kao i za praćenje stopa napuštanja i vremena učitavanja stranice.",
    "cookie-settings__subheading3": "Oglašivački kolačići",
    "cookie-settings__description3":
      "Oglašivački kolačići prikupljaju informacije s vašeg uređaja kako bi prikazali oglase koji odgovaraju vašim interesima. Ti kolačići postavljaju oglašivači s dopuštenjem vlasnika web stranice kako bi osigurali da je oglas koji vidite relevantan za vas.",
  ...
  hu: {
    ...
    "cookie-accept__text-1":
      "A cookie-k az Ön eszközén lévő információk elérésére és tárolására szolgálnak, így az Ön adatai alapján személyre szabott tartalmat kínálunk.",
    "cookie-accept__text-2":
      'Az "Elfogadom" kiválasztásával hozzájárul a cookie-k használatához. Elutasíthatja\n' +
    ...
    "cookie-settings__description1":
      "A nélkülözhetetlen vagy feltétlenül szükséges cookie-k olyan cookie-k, amelyek elengedhetetlenek a webhely megfelelő működéséhez. Ezek olyan cookie-k, amelyek szükségesek egy webhelyen történő online szolgáltatás biztosításához, vagy kizárólag a kommunikáció hálózaton keresztül.",
    "cookie-settings__subheading2": "Teljesítményt biztosító cookie-k",
    "cookie-settings__description2":
      "A teljesítményt növelő cookie-k adatokat gyűjtenek a webhelyen belüli felhasználói interakciókról. Analitikai cookie-knak nevezik őket, az oldalmegtekintések nyomon követésére, a felhasználói elköteleződés időtartamának mérésére, a hibásan működő oldalak hibáinak azonosítására, valamint a visszafordulási arány és a visszafordulási arány figyelésére szolgálnak. webhely betöltési idők.",
    "cookie-settings__subheading3": "Hirdetési cookie-k",
    "cookie-settings__description3":
      "A hirdetési cookie-k információkat gyűjtenek az Ön eszközéről, hogy az Ön érdeklődési körének megfelelő hirdetéseket jelenítsenek meg. Ezeket a cookie-kat a hirdetők állítják be a webhely tulajdonosának engedélyével annak érdekében, hogy a megjelenő hirdetések relevánsak legyenek az Ön számára.",
  ...
  in: {
    ...
    "cookie-accept__text-1":
      "Cookie digunakan untuk mengakses dan menyimpan informasi di perangkat Anda sehingga kami menawarkan konten yang dipersonalisasi berdasarkan data Anda.",
    "cookie-accept__text-2":
      'Dengan memilih "Saya setuju", Anda menyetujui penggunaan cookie kami. Anda dapat menolak\n' +
    ...
    "cookie-settings__intro":
      "Di sini Anda dapat mengatur preferensi cookie Anda:",
    "cookie-settings__subheading1": "Cookie Penting",
    "cookie-settings__description1":
      "Cookie penting atau cookie yang benar-benar diperlukan adalah cookie yang penting agar situs web dapat berfungsi dengan benar. Ini adalah cookie yang diperlukan untuk menyediakan layanan online di situs web atau digunakan semata-mata untuk melaksanakan atau memfasilitasi transmisi komunikasi melalui jaringan.",
    "cookie-settings__subheading2": "Cookie Kinerja",
    "cookie-settings__description2":
      "Cookie kinerja mengumpulkan data tentang interaksi pengguna dalam situs web. Disebut sebagai cookie analitik, cookie ini berfungsi untuk melacak tampilan halaman, mengukur durasi keterlibatan pengguna, mengidentifikasi kesalahan pada halaman yang tidak berfungsi, dan memantau rasio pentalan dan waktu pemuatan situs.",
    "cookie-settings__subheading3": "Cookie Iklan",
    "cookie-settings__description3":
      "Cookie iklan mengumpulkan informasi dari perangkat Anda untuk menampilkan iklan yang sesuai dengan minat Anda. Cookie ini disetel oleh pengiklan dengan izin pemilik situs web untuk memastikan iklan yang Anda lihat relevan bagi Anda.",
  ...
  it: {
    ...
    "cookie-accept__text-1":
      "I cookie vengono utilizzati per accedere e archiviare informazioni sul tuo dispositivo in modo da poter offrire contenuti personalizzati basati sui tuoi dati.",
    "cookie-accept__text-2":
      'Scegliendo "Accetto", acconsenti all\'utilizzo dei cookie. Puoi rifiutare\n' +
    ...
    "cookie-settings__description1":
      "I cookie essenziali o cookie strettamente necessari sono cookie essenziali per il corretto funzionamento di un sito Web. Si tratta di cookie necessari per fornire un servizio online su un sito Web o utilizzati esclusivamente per eseguire o facilitare la trasmissione di comunicazioni su una rete.",
    "cookie-settings__subheading2": "Cookie prestazionali",
    "cookie-settings__description2":
      "I cookie prestazionali raccolgono dati sulle interazioni dell'utente all'interno di un sito web. Denominati cookie analitici, servono a monitorare le visualizzazioni delle pagine, misurare la durata del coinvolgimento dell'utente, identificare errori su pagine malfunzionanti e monitorare sia la frequenza di rimbalzo che tempi di caricamento del sito.",
    "cookie-settings__subheading3": "Cookie pubblicitari",
    "cookie-settings__description3":
      "I cookie pubblicitari raccolgono informazioni dal tuo dispositivo per mostrare annunci che corrispondono ai tuoi interessi. Questi cookie sono impostati dagli inserzionisti con il permesso del proprietario del sito web per garantire che gli annunci che vedi siano pertinenti per te.",
  ...
  ja: {
    ...
    "cookie-accept__text-1":
      "Cookie は、お客様のデータに基づいてパーソナライズされたコンテンツを提供できるよう、お客様のデバイス上の情報にアクセスして保存するために使用されます。",
    "cookie-accept__text-2":
      "「同意する」を選択すると、Cookie の使用に同意したことになります。拒否することもできます\n" +
    ...
    "cookie-settings__description1":
      "必須 Cookie または厳密に必要な Cookie は、Web サイトが正しく機能するために不可欠な Cookie です。これらは、Web サイトでオンライン サービスを提供するために必要な Cookie、または送信を実行または促進するためにのみ使用される Cookie です。 ネットワークを介した通信。",
    "cookie-settings__subheading2": "パフォーマンス Cookie",
    "cookie-settings__description2":
      "パフォーマンス Cookie は、Web サイト内のユーザー インタラクションに関するデータを収集します。分析 Cookie と呼ばれ、ページ ビューを追跡し、ユーザー エンゲージメントの継続時間を測定し、誤動作しているページのエラーを識別し、直帰率と サイトの読み込み時間。",
    "cookie-settings__subHeading3": "広告用 Cookie",
    "cookie-settings__description3":
      "広告 Cookie は、ユーザーの興味に合った広告を表示するためにデバイスから情報を収集します。これらの Cookie は、表示される広告がユーザーに関連していることを確認するために、Web サイト所有者の許可を得て広告主によって設定されます。",
    "cookie-settings__preference-button": "設定を保存",
    "cookie-settings__policy-link": "Cookie ポリシー",
  },
  kk: {
    "cookie-accept__heading":
      "Сәлем! Айтпақшы, біз cookie файлдарын пайдаланып жатырмыз.",
    "cookie-accept__text-1":
      "Cookie файлдары сіздің деректеріңізге негізделген жекелендірілген мазмұнды ұсыну үшін құрылғыңыздағы ақпаратқа қол жеткізу және сақтау үшін пайдаланылады.",
    "cookie-accept__text-2":
      '"Келісемін" опциясын таңдау арқылы сіз cookie файлдарын пайдалануымызға келісесіз. Бас тартуыңызға болады\n' +
    ...
    "cookie-settings__intro":
      "Осында сіз cookie файлдарының теңшелімдерін басқара аласыз:",
    "cookie-settings__subheading1": "Маңызды cookie файлдары",
    "cookie-settings__description1":
      "Маңызды cookie файлдары немесе қатаң қажетті cookie файлдары веб-сайттың дұрыс жұмыс істеуі үшін маңызды болып табылатын cookie файлдары. Бұл веб-сайтта онлайн қызметті қамтамасыз ету үшін қажет немесе тек файлдарды жіберуді жүзеге асыру немесе жеңілдету үшін пайдаланылатын cookie файлдары. желі арқылы байланыс.",
    "cookie-settings__subheading2": "Өнімділік кукилері",
    "cookie-settings__description2":
      "Өнімділік cookie файлдары веб-сайттағы пайдаланушының өзара әрекеттесулері туралы деректерді жинайды. Аналитикалық cookie файлдары деп аталады, олар бет көріністерін қадағалауға, пайдаланушының қатысу ұзақтығын өлшеуге, дұрыс жұмыс істемейтін беттердегі қателерді анықтауға және кері шығу жылдамдығы мен екеуін де бақылауға қызмет етеді. сайтты жүктеу уақыттары.",
    "cookie-settings__subheading3": "Жарнамалық cookie файлдары",
    "cookie-settings__description3":
      "Жарнамалық cookie файлдары сіздің қызығушылықтарыңызға сәйкес келетін жарнамаларды көрсету үшін құрылғыңыздан ақпаратты жинайды. Бұл cookie файлдары сіз көретін жарнамалардың сізге сәйкес келетініне көз жеткізу үшін веб-сайт иесінің рұқсатымен жарнама берушілермен орнатылады.",
    "cookie-settings__preference-button": "Параметрлерді сақтау",
    "cookie-settings__policy-link": "Cookie саясаты",
  },
  ko: {
    "cookie-accept__heading":
      "안녕하세요! 그런데 우리는 쿠키를 사용하고 있습니다.",
    "cookie-accept__text-1":
      "쿠키는 귀하의 데이터를 기반으로 개인화된 콘텐츠를 제공하기 위해 귀하의 장치에 있는 정보에 액세스하고 정보를 저장하는 데 사용됩니다.",
    "cookie-accept__text-2":
      '"동의함"을 선택하면 쿠키 사용에 동의하는 것입니다. 거부할 수 있습니다.\n' +
    ...
    "cookie-settings__description1":
      "필수 쿠키 또는 반드시 필요한 쿠키는 웹사이트가 올바르게 작동하는 데 필수적인 쿠키입니다. 이는 웹사이트에서 온라인 서비스를 제공하는 데 필요하거나 다음의 전송을 수행하거나 촉진하는 데에만 사용되는 쿠키입니다. 네트워크를 통한 통신.",
    "cookie-settings__subheading2": "성능 쿠키",
    "cookie-settings__description2":
      "성능 쿠키는 웹사이트 내의 사용자 상호 작용에 대한 데이터를 수집합니다. 분석 쿠키라고 하는 쿠키는 페이지 조회수를 추적하고, 사용자 참여 기간을 측정하고, 오작동하는 페이지의 오류를 식별하고 이탈률과 이탈률을 모두 모니터링하는 데 사용됩니다. 사이트 로딩 시간.",
    "cookie-settings__subheading3": "광고 쿠키",
    "cookie-settings__description3":
      "광고 쿠키는 귀하의 관심분야에 맞는 광고를 표시하기 위해 귀하의 기기에서 정보를 수집합니다. 이 쿠키는 귀하가 보는 광고가 귀하와 관련이 있는지 확인하기 위해 웹사이트 소유자의 허가를 받아 광고주가 설정합니다.",
  ...
  ms: {
    ...
    "cookie-accept__text-1":
      "Kuki digunakan untuk mengakses dan menyimpan maklumat pada peranti anda supaya kami menawarkan kandungan yang diperibadikan berdasarkan data anda.",
    "cookie-accept__text-2":
      'Dengan memilih "Saya bersetuju", anda bersetuju dengan penggunaan kuki kami. Anda boleh menolak\n' +
    ...
    "cookie-settings__intro":
      "Di sini anda boleh menguruskan pilihan kuki anda:",
    "cookie-settings__subheading1": "Kuki Penting",
    "cookie-settings__description1":
      "Kuki penting atau kuki yang sangat diperlukan ialah kuki yang penting untuk tapak web berfungsi dengan betul. Ini adalah kuki yang diperlukan untuk menyediakan perkhidmatan dalam talian pada tapak web atau digunakan semata-mata untuk menjalankan atau memudahkan penghantaran komunikasi melalui rangkaian.",
    "cookie-settings__subheading2": "Kuki Prestasi",
    "cookie-settings__description2":
      "Kuki prestasi mengumpulkan data tentang interaksi pengguna dalam tapak web. Dirujuk sebagai kuki analitik, kuki tersebut berfungsi untuk menjejak paparan halaman, mengukur tempoh penglibatan pengguna, mengenal pasti ralat pada halaman yang tidak berfungsi dan memantau kedua-dua kadar lantunan dan masa memuatkan tapak.",
    "cookie-settings__subheading3": "Kuki Pengiklanan",
    "cookie-settings__description3":
      "Kuki pengiklanan mengumpul maklumat daripada peranti anda untuk memaparkan iklan yang sepadan dengan minat anda. Kuki ini ditetapkan oleh pengiklan dengan kebenaran pemilik tapak web untuk memastikan iklan yang anda lihat adalah berkaitan dengan anda.",
  ...
  nl: {
    ...
    "cookie-accept__text-1":
      "Cookies worden gebruikt om toegang te krijgen tot informatie op uw apparaat en deze op te slaan, zodat we gepersonaliseerde inhoud kunnen aanbieden op basis van uw gegevens.",
    "cookie-accept__text-2":
      'Door "Ik ga akkoord" te kiezen, stemt u in met ons gebruik van cookies. U kunt weigeren\n' +
    ...
    "cookie-settings__description3":
      "Advertentiecookies verzamelen informatie van uw apparaat om advertenties weer te geven die aansluiten bij uw interesses. Deze cookies worden door adverteerders geplaatst met toestemming van de website-eigenaar om ervoor te zorgen dat de advertenties die u ziet relevant voor u zijn.",
  ...
  pl: {
    ...
    "cookie-accept__text-1":
      "Pliki cookie służą do uzyskiwania dostępu do informacji i przechowywania ich na Twoim urządzeniu, dzięki czemu możemy oferować spersonalizowane treści w oparciu o Twoje dane.",
    "cookie-accept__text-2":
      "Wybierając „Zgadzam się”, wyrażasz zgodę na używanie przez nas plików cookie. Możesz odmówić\n" +
    ...
    "cookie-settings__intro":
      "Tutaj możesz zarządzać swoimi preferencjami dotyczącymi plików cookie:",
    "cookie-settings__subheading1": "Niezbędne pliki cookie",
    "cookie-settings__description1":
      "Niezbędne pliki cookie lub ściśle niezbędne pliki cookie to pliki cookie niezbędne do prawidłowego działania witryny internetowej. Są to pliki cookie niezbędne do świadczenia usług online w witrynie internetowej lub wykorzystywane wyłącznie do przeprowadzania lub ułatwiania przesyłania komunikacja przez sieć.",
    "cookie-settings__subheading2": "Wydajnościowe pliki cookie",
    "cookie-settings__description2":
      "Wydajnościowe pliki cookie gromadzą dane o interakcjach użytkowników w witrynie internetowej. Nazywane analitycznymi plikami cookie służą do śledzenia odsłon stron, pomiaru czasu trwania zaangażowania użytkownika, identyfikowania błędów na nieprawidłowo działających stronach oraz monitorowania zarówno współczynnika odrzuceń, jak i czasy ładowania witryny.",
    "cookie-settings__subheading3": "reklamowe pliki cookie",
    "cookie-settings__description3":
      "Reklamowe pliki cookie zbierają informacje z Twojego urządzenia, aby wyświetlać reklamy odpowiadające Twoim zainteresowaniom. Te pliki cookie są ustawiane przez reklamodawców za zgodą właściciela witryny, aby zapewnić, że wyświetlane reklamy będą dla Ciebie odpowiednie.",
  ...
  pt: {
    ...
    "cookie-accept__text-1":
      "Cookies são usados para acessar e armazenar informações em seu dispositivo para que possamos oferecer conteúdo personalizado com base em seus dados.",
    "cookie-accept__text-2":
      'Ao escolher "Concordo", você concorda com o uso de cookies. Você pode recusar\n' +
    ...
    "cookie-settings__intro":
      "Aqui você pode gerenciar suas preferências de cookies:",
    "cookie-settings__subheading1": "Cookies essenciais",
    "cookie-settings__description1":
      "Cookies essenciais ou cookies estritamente necessários são cookies essenciais para o correto funcionamento de um site. São cookies necessários para fornecer um serviço online em um site ou usados exclusivamente para realizar ou facilitar a transmissão de comunicações através de uma rede.",
    "cookie-settings__subheading2": "Cookies de desempenho",
    "cookie-settings__description2":
      "Cookies de desempenho coletam dados sobre as interações do usuário em um site. Chamados de cookies analíticos, eles servem para rastrear visualizações de páginas, medir a duração do envolvimento do usuário, identificar erros em páginas com mau funcionamento e monitorar as taxas de rejeição e tempos de carregamento do site.",
    "cookie-settings__subheading3": "Cookies de publicidade",
    "cookie-settings__description3":
      "Cookies de publicidade coletam informações do seu dispositivo para mostrar anúncios que correspondem aos seus interesses. Esses cookies são definidos por anunciantes com a permissão do proprietário do site para garantir que os anúncios que você vê sejam relevantes para você.",
  ...
  ro: {
    ...
    "cookie-accept__text-1":
      "Cookie-urile sunt folosite pentru a accesa și stoca informații pe dispozitivul dvs., astfel încât să oferim conținut personalizat pe baza datelor dvs.",
    "cookie-accept__text-2":
      'Alegând "Sunt de acord", sunteți de acord cu utilizarea cookie-urilor. Puteți refuza\n' +
  ...
  ru: {
    ...
    "cookie-accept__text-1":
      "Файлы cookie используются для доступа и хранения информации на вашем устройстве, поэтому мы предлагаем персонализированный контент на основе ваших данных.",
    "cookie-accept__text-2":
      "Выбирая «Я согласен», вы соглашаетесь на использование нами файлов cookie. Вы можете отказаться\n" +
    ...
    "cookie-settings__intro":
      "Здесь вы можете управлять настройками файлов cookie:",
    "cookie-settings__subheading1": "Основные файлы cookie",
    "cookie-settings__description1":
      "Основные файлы cookie или строго необходимые файлы cookie — это файлы cookie, которые необходимы для правильной работы веб-сайта. Это файлы cookie, которые необходимы для предоставления онлайн-услуг на веб-сайте или используются исключительно для выполнения или облегчения передачи связь по сети.",
    "cookie-settings__subheading2": "Файлы cookie производительности",
    "cookie-settings__description2":
      "Производительные файлы cookie собирают данные о взаимодействии пользователей на веб-сайте. Их называют аналитическими файлами cookie. Они служат для отслеживания просмотров страниц, измерения продолжительности взаимодействия с пользователем, выявления ошибок на неработающих страницах, а также для мониторинга показателей отказов и время загрузки сайта.",
    "cookie-settings__subheading3": "Рекламные файлы cookie",
    "cookie-settings__description3":
      "Рекламные файлы cookie собирают информацию с вашего устройства, чтобы показывать рекламу, соответствующую вашим интересам. Эти файлы cookie устанавливаются рекламодателями с разрешения владельца веб-сайта, чтобы гарантировать, что реклама, которую вы видите, актуальна для вас.",
  ...
  sv: {
    ...
    "cookie-accept__text-1":
      "Cookies används för att komma åt och lagra information på din enhet så att vi erbjuder personligt innehåll baserat på dina data.",
    "cookie-accept__text-2":
      'Genom att välja "Jag godkänner", samtycker du till vår användning av cookies. Du kan vägra\n' +
    ...
    "cookie-settings__description1":
      "Nödvändiga cookies eller absolut nödvändiga cookies är cookies som är nödvändiga för att en webbplats ska fungera korrekt. Dessa är cookies som är nödvändiga för att tillhandahålla en onlinetjänst på en webbplats eller används enbart för att utföra eller underlätta överföring av kommunikation över ett nätverk.",
    "cookie-settings__subheading2": "Prestationscookies",
    "cookie-settings__description2":
      "Prestanda-cookies samlar in data om användarinteraktioner på en webbplats. Kallas analytiska cookies, de tjänar till att spåra sidvisningar, mäta varaktigheten av användarens engagemang, identifiera fel på felaktiga sidor och övervaka både avvisningsfrekvenser och sidans laddningstider.",
    "cookie-settings__subheading3": "Reklamcookies",
    "cookie-settings__description3":
      "Annonscookies samlar in information från din enhet för att visa annonser som matchar dina intressen. Dessa cookies ställs in av annonsörer med webbplatsägarens tillåtelse för att säkerställa att annonserna du ser är relevanta för dig.",
  ...
  sk: {
    ...
    "cookie-accept__text-1":
      "Súbory cookie sa používajú na prístup k informáciám na vašom zariadení a ich ukladanie, aby sme vám mohli ponúknuť prispôsobený obsah založený na vašich údajoch.",
    "cookie-accept__text-2":
      'Výberom možnosti "Súhlasím" súhlasíte s naším používaním súborov cookie. Môžete odmietnuť\n' +
    ...
    "cookie-settings__intro":
      "Tu môžete spravovať svoje preferencie súborov cookie:",
    "cookie-settings__subheading1": "Základné súbory cookie",
    "cookie-settings__description1":
      "Nevyhnutné súbory cookie alebo nevyhnutne potrebné súbory cookie sú súbory cookie, ktoré sú nevyhnutné na správne fungovanie webovej lokality. Sú to súbory cookie, ktoré sú potrebné na poskytovanie online služby na webovej lokalite alebo sa používajú výlučne na vykonávanie alebo uľahčenie prenosu komunikácia cez sieť.",
    "cookie-settings__subheading2": "Súbory cookie na zvýšenie výkonu",
    "cookie-settings__description2":
      "Súbory cookie výkonnosti zhromažďujú údaje o interakciách používateľov v rámci webovej lokality. Nazývajú sa aj analytické súbory cookie a slúžia na sledovanie zobrazení stránky, meranie trvania interakcie používateľa, identifikáciu chýb na nefunkčných stránkach a sledovanie miery odchodov a časy načítania stránky.",
    "cookie-settings__subheading3": "Reklamné súbory cookie",
    "cookie-settings__description3":
      "Reklamné súbory cookie zhromažďujú informácie z vášho zariadenia na zobrazovanie reklám, ktoré zodpovedajú vašim záujmom. Tieto súbory cookie nastavujú inzerenti so súhlasom vlastníka webových stránok, aby zabezpečili, že reklamy, ktoré sa vám zobrazujú, sú pre vás relevantné.",
  ...
  tr: {
    ...
    "cookie-accept__text-1":
      "Çerezler, verilerinize dayalı olarak kişiselleştirilmiş içerik sunabilmemiz için cihazınızdaki bilgilere erişmek ve bilgileri depolamak için kullanılır.",
    "cookie-accept__text-2":
      '"Kabul ediyorum"u seçerek çerez kullanmamıza izin vermiş olursunuz. Reddetebilirsiniz\n' +
    ...
    "cookie-settings__description1":
      "Temel çerezler veya kesinlikle gerekli çerezler, bir web sitesinin düzgün çalışması için gerekli olan çerezlerdir. Bunlar, bir web sitesinde çevrimiçi bir hizmet sağlamak için gerekli olan veya yalnızca aktarımı gerçekleştirmek veya kolaylaştırmak için kullanılan çerezlerdir. bir ağ üzerinden iletişim.",
    "cookie-settings__subheading2": "Performans Çerezleri",
    "cookie-settings__description2":
      "Performans çerezleri, bir web sitesi içindeki kullanıcı etkileşimleri hakkında veri toplar. Analiz çerezleri olarak anılırlar, sayfa görüntülemelerini izlemeye, kullanıcı etkileşiminin süresini ölçmeye, arızalı sayfalardaki hataları tespit etmeye ve hem hemen çıkma oranlarını hem de izlemeyi izlemeye yararlar. site yükleme süreleri.",
    "cookie-settings__subheading3": "Reklam Çerezleri",
    "cookie-settings__description3":
      "Reklam çerezleri, ilgi alanlarınıza uygun reklamlar göstermek için cihazınızdan bilgi toplar. Bu çerezler, gördüğünüz reklamların sizinle alakalı olmasını sağlamak için reklamverenler tarafından web sitesi sahibinin izniyle ayarlanır.",
  ...
  ua: {
    ...
    "cookie-accept__text-1":
      "Файли cookie використовуються для доступу та зберігання інформації на вашому пристрої, щоб ми пропонували персоналізований вміст на основі ваших даних.",
    "cookie-accept__text-2":
      'Вибираючи "Я згоден", ви погоджуєтеся на використання файлів cookie. Ви можете відмовитися\n' +
    ...
    "cookie-settings__intro":
      "Тут ви можете керувати налаштуваннями файлів cookie:",
    "cookie-settings__subheading1": "Основні файли cookie",
    "cookie-settings__description1":
      "Основні файли cookie або суворо необхідні файли cookie — це файли cookie, необхідні для правильного функціонування веб-сайту. Це файли cookie, які необхідні для надання онлайн-сервісу на веб-сайті або використовуються виключно для виконання або полегшення передачі спілкування через мережу.",
    "cookie-settings__subheading2": "Ефективні файли cookie",
    "cookie-settings__description2":
      "Ефективні файли cookie збирають дані про взаємодію користувачів на веб-сайті. Називаються аналітичними файлами cookie, вони служать для відстеження переглядів сторінок, вимірювання тривалості взаємодії користувачів, виявлення помилок на несправних сторінках і моніторингу показників відмов і час завантаження сайту.",
    "cookie-settings__subheading3": "Рекламні файли cookie",
    "cookie-settings__description3":
      "Рекламні файли cookie збирають інформацію з вашого пристрою, щоб показувати рекламу, яка відповідає вашим інтересам. Ці файли cookie встановлюються рекламодавцями з дозволу власника веб-сайту, щоб гарантувати, що реклама, яку ви бачите, відповідає вам.",
  ...
  vi: {
    ...
    "cookie-accept__text-1":
      "Cookie được sử dụng để truy cập và lưu trữ thông tin trên thiết bị của bạn để chúng tôi cung cấp nội dung được cá nhân hóa dựa trên dữ liệu của bạn.",
    "cookie-accept__text-2":
      'Bằng cách chọn "Tôi đồng ý", bạn đồng ý cho chúng tôi sử dụng cookie. Bạn có thể từ chối\n' +
    ...
    "cookie-settings__intro":
      "Tại đây bạn có thể quản lý các tùy chọn cookie của mình:",
    "cookie-settings__subheading1": "Cookie cần thiết",
    "cookie-settings__description1":
      "Cookie thiết yếu hoặc cookie thực sự cần thiết là những cookie cần thiết để trang web hoạt động chính xác. Đây là những cookie cần thiết để cung cấp dịch vụ trực tuyến trên trang web hoặc chỉ được sử dụng để thực hiện hoặc hỗ trợ việc truyền tải thông tin truyền thông qua mạng.",
    "cookie-settings__subheading2": "Cookie hiệu suất",
    "cookie-settings__description2":
      "Cookie hiệu suất thu thập dữ liệu về tương tác của người dùng trong một trang web. Được gọi là cookie phân tích, chúng phục vụ để theo dõi lượt xem trang, đo lường thời lượng tương tác của người dùng, xác định lỗi trên các trang bị trục trặc và theo dõi cả tỷ lệ thoát và thời gian tải trang web.",
    "cookie-settings__subheading3": "Cookie quảng cáo",
    "cookie-settings__description3":
      "Cookie quảng cáo thu thập thông tin từ thiết bị của bạn để hiển thị quảng cáo phù hợp với sở thích của bạn. Những cookie này được nhà quảng cáo đặt với sự cho phép của chủ sở hữu trang web để đảm bảo quảng cáo bạn nhìn thấy có liên quan đến bạn.",
...
class OnCookies {
  ...
  createBanner() {
    ...
    dialog.className =
      "ont-rounded-xl ont-border ont-border-neutral-300 ont-overflow-hidden ont-flex ont-flex-col ont-items-center ont-justify-center ont-gap-4 ont-max-w-[300px] sm:ont-max-w-[400px] ont-shadow-2xl ont-opacity-0 ont-transition-opacity ont-duration-700 ont-hidden";
    ...
    savePreferencesButton.className =
      "ont-flex ont-w-fit ont-items-start ont-py-3 ont-font-medium ont-transition-all ont-duration-300 ont-bg-blue-600 ont-text-white ont-px-2 ont-rounded-xl hover:ont-brightness-75";
  ...
  createCookieIcon() {
    ...
    cookieIcon.className =
      "ont-flex ont-hidden ont-items-center ont-justify-center ont-h-12 ont-w-12 ont-fixed ont-bottom-[3%] ont-left-[3%] ont-rounded-full ont-bg-white ont-border ont-border-slate-300 hover:ont-bg-blue-200 ont-group hover:ont-border-blue-300 ont-transition-all ont-duration-300 ont-z-[9999px]";
...
function updatePreference(
  ...
  if (!COOKIE_TYPES.includes(prefName))
    throw new Error("Unsupported cookie type!");
