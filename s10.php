      ...
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="
          ...
          <div class="border-5 border-primary ps-4 mb-5">
            <h1 class="display-6 mb-0">
              The BY7 Table: Where Connections and Memories Blossom
            </h1>
          </div>
          <p class="mb-5">
            BdagLiving's BY7 table transcends the conventional dining surface; it's an open invitation for meaningful conversation and a canvas for crafting enduring memories. With its round silhouette and crisp white finish, this table exudes modern elegance, effortlessly enhancing any kitchen or dining area.
            <br></br>
            Organic curves and sleek lines cultivate a warm and inviting ambiance, ideal for intimate dinners or lively gatherings alike. Whether it's a relaxed family meal or a special occasion, the BY7 table encourages connection, setting the scene for cherished moments.
            <br></br>
            Crafted from premium materials for lasting sophistication, the pristine white finish adds a touch of refinement and enhances the sense of spaciousness in smaller areas. Versatile enough to complement both traditional and contemporary settings, the BY7 seamlessly integrates into your home, becoming a captivating centerpiece. Explore how the BY7 can elevate your dining experience and infuse your haven with timeless style.
          </p>
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" style="
          ...
          <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px">
            <img class="position-absolute w-100 h-100" src="img/10.jpg" alt="" style="object-fit: cover" />
          </div>
        </div>
      </div>
    </div>
