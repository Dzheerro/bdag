      ...
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="
          ...
          <div class="border-5 border-primary ps-4 mb-5">
            <h1 class="display-6 mb-0">
              Unveiling Order and Opulence: The BdagLiving 3D Wardrobe
            </h1>
          </div>

          <p class="mb-5">
            The BdagLiving 3D Wardrobe isn't just about organizing clothes - it's a harmonious blend of storage and sophistication. Step into a roomy sanctuary flooded with light. Crafted from premium "milk oak," it emanates warmth, while its generous dimensions (1100x240x60 cm) cater to everything from attire to cherished possessions. Yet, practicality meets style with the sleek silver mirror gracing the front. Not only does it visually expand your space, but it also adds a touch of opulence. And the pièce de résistance? A glossy golden beige profile that elevates the wardrobe from mere storage to a radiant centerpiece, exuding grace. For those in search of a fusion of functionality and unmatched elegance, the BdagLiving 3D Wardrobe is the ultimate choice, creating a clutter-free oasis that complements any interior decor.
          </p>
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" style="
          ...
          <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px">
            <img class="position-absolute w-100 h-100" src="img/7.jpg" alt="" style="object-fit: cover" />
          </div>
        </div>
      </div>
    </div>
