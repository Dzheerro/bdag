      ...
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="
          ...
          <div class="border-5 border-primary ps-4 mb-5">
            <h1 class="display-6 mb-0">
              Unwind in Modern Luxury: The Graf-854 Sofa by BdagLiving
            </h1>
          </div>

          <p class="mb-5">
            Elevate your living room into a sanctuary of relaxation and elegance with the Graf-854 sofa by BdagLiving. More than just a standard couch, it's an invitation to pure comfort. Sink into its deep, sumptuous cushions and feel your worries melt away in luxurious bliss. Its sleek lines and refined design elevate the ambiance of your entire living space, transforming it into a contemporary retreat you'll adore lounging in.

            <br></br>

            Tailor the upholstery to seamlessly blend with your current decor, and customize your comfort with adjustable headrests. Thanks to its modular design, you can effortlessly adapt it to any gathering, whether it's an intimate conversation or a lively get-together. Crafted with premium materials for enduring durability, the Graf-854 isn't just a furniture piece; it's the heart of your modern living room, designed for comfort, timeless style, and years of enjoyment.
          </p>
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" style="
          ...
          <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px">
            <img class="position-absolute w-100 h-100" src="img/8.jpg" alt="" style="object-fit: cover" />
          </div>
        </div>
      </div>
    </div>
