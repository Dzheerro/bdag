      ...
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="
          ...
          <div class="border-5 border-primary ps-4 mb-5">
            <h1 class="display-6 mb-0">
              Declutter in Style: The Liana-785 Chest by BdagLiving
            </h1>
          </div>

          <p class="mb-5">
            Experience more than just storage with the Liana-785 chest of drawers from BdagLiving; it's a contemporary masterpiece. This modern gem offers ample storage space, ideal for taming clutter in any room, whether it's a bedroom or living area. Crafted with top-quality materials for enduring style, the Liana-785 showcases smooth-gliding drawers and sleek handles for effortless use. Its sleek design effortlessly complements a range of decor styles. Take charge of your organization and enhance your home's aesthetics with the Liana-785 - a seamless fusion of functionality and flair.
          </p>
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" style="
          ...
          <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px">
            <img class="position-absolute w-100 h-100" src="img/9.jpg" alt="" style="object-fit: cover" />
          </div>
        </div>
      </div>
    </div>
